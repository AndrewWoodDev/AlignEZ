...
sys.path.append('../')
model =  AutoModelForCausalLM.from_pretrained("/home/ubuntu/DPO/huggingface_trl_dpo/dpo_ultrafeedback_binarized_5percent/checkpoint-100", 
                                              low_cpu_mem_usage=True, torch_dtype=torch.float16, device_map="auto", trust_remote_code=True)
tokenizer = AutoTokenizer.from_pretrained("/home/ubuntu/DPO/huggingface_trl_dpo/dpo_ultrafeedback_binarized_5percent/checkpoint-100")
...
df_generated.to_csv('self_generated_data/tqa_DPO_5p.csv', index=False)
